...
for theme in '' '-Rosewater' '-Flamingo' '-Pink' '-Red' '-Maroon' '-Mauve' '-Lavender' '-Blue' '-Sapphire' '-Sky' '-Teal' '-Green' '-Yellow' '-Peach' '-Grey'; do
    for type in '' '-Frappe' '-Macchiato'; do
        ...
        if [[ "$type" == '-Frappe' ]]; then
            background_light='#c0caf5' # Frappe background light
            background_dark='#24283b' # Frappe background dark
            base_dark='#1a1b26'        # Frappe base dark
            surface_dark='#3b4261'     # Frappe surface dark
        ...
        if [[ "$type" == '-Macchiato' ]]; then
            background_light='#c8d3f5' # Macchiato background light
            background_dark='#222436' # Macchiato background dark
            base_dark='#1a1b26'        # Macchiato base dark
            surface_dark='#3b4261'     # Macchiato surface dark
